...
# This file was *autogenerated* from the file src/ts/ring.sage
...
class RingTannakianSymbols(TannakianSymbols):
    ...
    class Element(TannakianSymbols.Element):
        ...
        def getPointCounts(self, length = None):
            return LazyList(lambda x: parent(self).base_monoid.one() if x==_sage_const_0  else self.adamsoperation(x).trace(), printed=length)
